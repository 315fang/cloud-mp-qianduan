...
const copywritingTemplates = [
  {
    ...
    tag: "朋友圈",
    title: "日常种草",
    text: "用了三个月的云肌焕活精华，皮肤真的变了！毛孔细了、暗沉少了，最重要的是早上起来脸很水润，妆感也好多了✨ 用完一瓶回购第三瓶了，强烈推荐给我的朋友们～有需要的私我，有专属优惠！",
  },
  {
    id: 2,
    tag: "朋友圈",
    title: "活动促销",
    text: "【好消息】云肌护肤品本月限时优惠，我的专属折扣码 YJ2024001 还剩最后几天！精华液、面霜、眼霜全线参与，买两件再送小样礼盒。有意向的朋友快来找我，帮你选最适合的套组～",
  },
  {
    id: 3,
    tag: "社群",
    title: "品牌介绍",
    text: "给大家介绍一个我亲测很好用的轻奢护肤品牌——云肌。主打成分党，配方透明公开，5%烟酰胺+雪绒花干细胞萃取，价格比大牌实惠很多，效果真不输！皮肤科医生测试通过，敏感肌也能用～",
  },
  {
    id: 4,
    tag: "私信",
    title: "客户跟进",
    text: "亲爱的，你上次问的云肌精华液现在有现货了！我帮你备了一瓶，原价 ¥780，通过我拿有专属优惠，还送小样试用包。你要的话我今天就给你安排发货，到了一定要跟我反馈效果哦～",
  },
];
          ...
          <div className="p-4 space-y-4">
            ...
            <div className="bg-white rounded-2xl p-4 shadow-sm">
              ...
              <div className="space-y-2">
                {[
                  { level: "L1 普通经销商", direct: "10%", team: "3%", color: "#8C7B6B" },
